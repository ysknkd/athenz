...
describe('Pagination', () => {
    ...
    describe('rendering', () => {
        it('should render pagination component', () => {
            ...
            expect(screen.getByText('Showing 1-10 of 50 members')).toBeInTheDocument();
        ...
        it('should show correct info text for different page ranges', () => {
            ...
            expect(screen.getByText('Showing 11-20 of 50 members')).toBeInTheDocument();

            rerender(<Pagination {...defaultProps} currentPage={5} />);
            expect(screen.getByText('Showing 41-50 of 50 members')).toBeInTheDocument();
        });

        it('should handle partial last page correctly', () => {
            render(<Pagination {...defaultProps} totalItems={47} totalPages={5} currentPage={5} />);
            
            expect(screen.getByText('Showing 41-47 of 47 members')).toBeInTheDocument();
        });
    ...
    describe('edge cases', () => {
        it('should render correctly with single page', () => {
            ...
            expect(screen.getByText('Showing 1-5 of 5 members')).toBeInTheDocument();
        ...
        it('should render correctly with zero pages', () => {
            ...
            expect(screen.getByText('Showing 0-0 of 0 members')).toBeInTheDocument();
            expect(screen.getByRole('button', { name: /previous/i })).toBeDisabled();
            expect(screen.getByRole('button', { name: /next/i })).toBeDisabled();
        });
        ...
        it('should handle invalid current page gracefully', () => {
            ...
            expect(screen.getByText('Showing 91-50 of 50 members')).toBeInTheDocument();
        });
    });

    describe('custom props', () => {
        it('should use custom items per page for calculations', () => {
            render(<Pagination {...defaultProps} itemsPerPage={25} totalItems={75} />);
            
            expect(screen.getByText('Showing 1-25 of 75 members')).toBeInTheDocument();
        });
