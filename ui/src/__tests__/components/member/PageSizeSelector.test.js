...
describe('PageSizeSelector', () => {
    ...
    describe('rendering', () => {
        ...
        it('should render with custom options', () => {
            ...
            render(<PageSizeSelector {...defaultProps} options={customOptions} value={25} />);
    ...
    describe('edge cases', () => {
        ...
        it('should handle value not in options', () => {
            render(<PageSizeSelector {...defaultProps} value={75} options={[30, 50, 100]} />);
        ...
        it('should handle large numbers', () => {
            ...
            render(<PageSizeSelector {...defaultProps} options={largeOptions} value={5000} />);
    ...
    describe('styling and layout', () => {
        it('should apply custom CSS classes', () => {
            const { container } = render(<PageSizeSelector {...defaultProps} className="custom-selector" />);
    ...
    describe('integration scenarios', () => {
        ...
        it('should maintain state across re-renders', () => {
            const { rerender } = render(<PageSizeSelector {...defaultProps} value={30} />);
